...
which will be referenced in `infra/aws/us-east-2/production/locals.tf`:
...
Other variables that needs replacement resides in `infra/aws/us-east-2/production/variables.tf`:
...
- `infra/aws/us-east-2/production/providers.tf`
- `infra/aws/us-east-2/production/terraform-state.tf`
...
alb_dns = "ecs-prod-alb-xxxxxxxxxx.us-east-2.elb.amazonaws.com"
caller_arn = "arn:aws:iam::xxxxxxxxxxxx:user/x"
caller_user = "AXXXXXXXXXXXXXXXXXXXXXX"
db_address = "ecs-prod-rds-instance.xxxxxxxxxxxx.us-east-2.rds.amazonaws.com"
environment_name = "prod"
service_hostname = "www.rbkr.xyz"

~/aws-terraform-cicd-java-springboot/infra/aws/us-east-2/production main* 4m 24s
```
